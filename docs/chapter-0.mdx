...
![29-29-41 triangle](/img/chapter-0/triangle-29-29-41.png)
![3-4-5 triangle](/img/chapter-0/triangle-3-4-5.png)
...
<BrowserOnly>
  {() => {
    const src = useBaseUrl('/if-then.html');
    return (
      <iframe
        src={src}
        style={{ width: '100%', height: '420px', border: 'none' }}
        title="If-Then logic explorer"
      />
    );
  }}
</BrowserOnly>
