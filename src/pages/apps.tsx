...
/* --------------------------------------------------------------
   Inline CSS – feel free to move this into apps.module.css later
----------------------------------------------------------------*/
const styles = /* css */ `
:root{--primary:#1565c0;--light:#f5f5f5;--mid:#e0e0e0;--dark:#424242;}
*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
body.theme-apps{font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Helvetica,Arial,sans-serif;background:var(--light);color:#212121;padding:2rem}
...
.tabs a{display:block;padding:.5rem 1rem .4rem;font-weight:600;border-radius:4px 4px 0 0;background:var(--light);color:var(--primary);text-decoration:none}
...
h2{font-size:1.75rem;color:var(--dark);margin:2rem 0 1rem;border-bottom:2px solid var(--primary);padding-bottom:.25rem}

/* cards */
.grid{display:grid;gap:1.5rem;grid-template-columns:repeat(auto-fit,minmax(280px,1fr))}
.card{background:#fff;border:1px solid var(--mid);border-radius:8px;box-shadow:0 4px 8px rgba(0,0,0,.08);text-decoration:none;color:inherit;transition:.2s}
...
/* --------------------------------------------------------------
   Sync tab highlighting with location.hash
----------------------------------------------------------------*/
function HashSync() {
  return (
    <script
...
window.addEventListener('DOMContentLoaded', syncTab);
`,
      }}
    />
  );
...
export default function AppsPage() {
  return (
    <Layout title="Interactive Apps" wrapperClassName="theme-apps" noFooter>
      <style>{styles}</style>
      <HashSync />
      ...
      <main>
        ...
        <section id="arithmetic" className="pane">
          ...
          <div className="grid">
            <a className="card" href="https://asghariamir.github.io/maths/Integer-Panel-Playground.html" target="_blank" rel="noopener">
              <div className="content"><h3>Integer Panel Playground</h3><p>Visual tool for integer addition & subtraction.</p></div>
            </a>
            <a className="card" href="https://asghariamir.github.io/maths/multiplication-web.html" target="_blank" rel="noopener">
              <div className="content"><h3>Multiplication Web</h3><p>Unlock multiplication facts via distributive property.</p></div>
            </a>
            <a className="card" href="https://asghariamir.github.io/maths/multiplicative-sums.html" target="_blank" rel="noopener">
              <div className="content"><h3>Multiplicative Sums</h3><p>Colour pad for exploring sums of first N powers.</p></div>
            </a>
          </div>
        </section>
